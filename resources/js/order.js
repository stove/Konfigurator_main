...
// Initialize Variables
        ...
        function UpdateTotal() {
            ...
            child.each(function () {
                ...
                //TODO here I need to check waht is happening ....almost there.......
                ...
                if(currtag == "INPUT" && $(this).attr('type') == "hidden")
                {
                    ...
                    if($(this).attr('data-price')) {
                        ...
                        if (currlabel != '') {
                            ...
                            console.log(" pushar currlabel + settings.currency + hiddeninputval till seledtedformvalues!!!!!!!!");

                            console.log("currlabel är inte != tom  då verkar hiddeninputval pushas på selectedformvalues ");
                            if($.isNumeric(hiddeninputval) && hiddeninputval !=0)
